// =============================================================================
// DEPRECATED — Typo in package name (contant).
// Moved to com.sts.utils.constant.AppConstants
...
// String INVOICE_NUMBER_EXISTS = "Purchase with invoice number '%s' already
// exists";
...
// String CREATING_ADJUSTMENT = "Creating adjustment for variant: {}, unit: {},
// quantity: {}";
